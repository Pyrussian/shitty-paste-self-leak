...
#pragma region Aimbot
	...
	resolver.AddItem("Lowerbody Auto");
	resolver.AddItem("Lowerbody/Freestanding");
	resolver.AddItem("Delta");
...
#pragma endregion Setting up the Options controls
	...
	ChamsGroup.PlaceLabledControl(0, "Enemy Only", this, &ChamsEnemyOnly); //to-do
...
//	worldgroup.PlaceLabledControl(0, "Refresh Sky", this, &customskies2);
	...
	worldgroup.PlaceLabledControl(0, "Asus Props", this, &asusamount);
...
#pragma region Other
	...
	OtherGroup.PlaceLabledControl(0, "Flash Amount", this, &flashAlpha); //to-do


	OtherNoSmoke.SetFileId("otr_nosmoke");
	OtherGroup.PlaceLabledControl(0, "Wireframe Smoke", this, &OtherNoSmoke); //to-do

	OtherNoScope.SetFileId("otr_noscope");
	OtherGroup.PlaceLabledControl(0, "No-Scope", this, &OtherNoScope);
	...
	OtherGroup.PlaceLabledControl(0, "Bullet Beams", this, &BulletTracers);

	beamtime.SetFileId("otr_beamtime");
	beamtime.SetBoundaries(0.1, 10);
	beamtime.SetValue(2);
	OtherGroup.PlaceLabledControl(0, "Beam time", this, &beamtime);



	manualaa.SetFileId("manualaa");
	OtherGroup.PlaceLabledControl(0, "Manual Anti-Aim Indicator", this, &manualaa);

	zoom.SetFileId("zoom");
	OtherGroup.PlaceLabledControl(0, "Zoom (pretty dank tbh)", this, &zoom);
...
#pragma region Other
	...
	OtherGroup.PlaceLabledControl(0, "Fake Ping", this, &FakePingValue);
	...
	AntiAimGroup.PlaceLabledControl(3, "Break LBY", this, &antilby);

	BreakLBYDelta.SetFileId("b_antilby");
	BreakLBYDelta.SetBoundaries(35, 180);
	BreakLBYDelta.SetValue(90);
	AntiAimGroup.PlaceLabledControl(3, "Break LBY range", this, &BreakLBYDelta);
